        ...
        <Stack direction="row" sx={{ py: 2, pl: 2, pr: 1, pb: 0, gap: 1, justifyContent: 'space-between', alignItems: 'start', }}>
          ...
          <span className="btn" onClick={toggleDrawer(false)}>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M14.625 9.375L9.375 14.625" stroke="#334155" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M9.375 9.375L14.625 14.625" stroke="#334155" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </span>
        </Stack>
        <Divider />
